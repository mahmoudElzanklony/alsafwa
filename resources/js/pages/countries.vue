<template>
    <div>
        ...
        <div class="page-content">
            <h2 class="main-title">مرحبا بك في بيانات المنشأ</h2>

            <div class="container mt-5">
                <p class="text-left">
                    <button class="btn btn-outline-primary" @click="item = null" data-toggle="modal" data-target="#saveItem">اضافه منشأ جديد</button>
                </p>
                    ...
                    <table class="myTable table table-bordered  table-hover text-center table-striped">
                        ...
                        <tr v-for="item in output" :key="item.id">
                            ...
                            <td class="control">
                                ...
                                <span><i @click="deleteItem(item.id,'countries')" class="ri-delete-bin-line"></i></span>
                            </td>
                        </tr>
                        </tbody>
                    </table>
